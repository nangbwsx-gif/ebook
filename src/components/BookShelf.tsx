  ...
  return (
    <div className="space-y-12">
      ...
      {uncategorizedBooks.length > 0 && (
        <section>
          <div className="flex items-center gap-3 mb-6">
            <div className="h-5 w-1 bg-gray-500 rounded-full" />
            <h2 className="text-lg font-bold text-gray-400">未分类</h2>
            <span className="text-sm text-gray-500">({uncategorizedBooks.length}本)</span>
          </div>
          <div className="shelf-board rounded-lg p-6 opacity-80">
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-6">
      ...
      {categories.length === 0 && uncategorizedBooks.length === 0 && (
        <div className="text-center py-20">
          <div className="w-20 h-20 mx-auto text-gray-700 mb-4">
